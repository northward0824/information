<template>
	<div class="userLogin">
		<van-nav-bar title="新建案件" left-text="返回" left-arrow @click-left="onClickLeft" @click-right="onClickRight">
	...
	export default {
		data() {
			return {
				...
				fujiaimg:[{url:'https://ss1.bdstatic.com/5eN1bjq8AAUYm2zgoY3K/r/www/cache/static/protocol/https/home/img/qrcode/zbios_x2_5869f49.png'}],
		...
		methods: {
			...
			submitsuccess() {
				...
				console.log(this.$route.query.eventVerifyTaskId)
				if(this.$route.query.eventVerifyTaskId || this.$route.query.eventVerifyTaskId == 0){
					data.eventVerifyTaskId = this.$route.query.eventVerifyTaskId
				}
				this.$api
