<template>
	<div class="userLogin">
		...
		<div class="overflowauto">
			...
			<div style="height: 1rem;background: #D6DAF7;display: flex;align-items: center;justify-content: space-between;padding: 0 .4rem;" @click="goCheckDetail">
				<div style="font-size: .3rem;color: #333;border-left: 4px solid #6A7CFC;height: .4rem;padding-left: .1rem;">核查结果</div>
				<div style="font-size: .28rem;">	<van-icon name="arrow" size=".2rem" /></div>
			</div>
		</div>
