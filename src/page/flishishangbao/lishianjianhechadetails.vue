    ...
    <div class="overflowauto">
      ...
      <div class="zhongjian">
        ...
        <div>
         ...
         <div style="border-bottom:1px solid #F2F2F2;padding-bottom:.1rem;margin-bottom:.1rem;margin-top:.5rem;">
          <div style="float:left;color:gray;">核查人 :</div>
          <div style="float:right;width:75%;">{{checkName}}</div>
          <div style="clear:both;"></div>
        </div>
      </div>
    </div>
    ...
    getsldkfjpaidosjgs(){
      ...
      this.$api
        ...
        .then(res => {
          if (res) {
            if (res.data.code == 0) {
              this.checkName = res.data.data.apiEventProcessDTO.checkerName;
            }
          }
        })
        .catch(err => {
